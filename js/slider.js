$().ready(function(){ 
  ...
  let odjectlist = [
    ...
    },
    {
      ...
      title: 'Ваш старый куриный знакомый, с рубленным бифштексом с 100% говядины, тремя кусочками нежнейшего сыра эмменталь, двумя помидорами, луком, салатом и соусом гриль теперь с добавлением экзотического соуса чураско.',
    },
  ]
